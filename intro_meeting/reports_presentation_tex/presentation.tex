...
\begin{frame}
  ...
  \begin{minipage}{0.59\linewidth}
    ...
    \item What did I measure and what are the \textbf{final results}
      of my experiment?
    \item How do I \textbf{illustrate} this results in an easy way?
...
\begin{frame}
  \frametitle{Theory and ExperimentalSetup}
  \begin{minipage}{0.39\linewidth}
    \begin{figure}[h]
      \centering
...
%    \vspace{-0.5cm}
    \begin{itemize}
    \item  What informations are necessary to \textbf{redo} my experiment
...
\begin{frame}
  ...
  \begin{minipage}{0.59\linewidth}
    ...
    \item How did this results contribute to our knowledge from a
...
\begin{frame}
  ...
  \begin{minipage}{0.59\linewidth}
    ...
    \begin{itemize}
      \item Do I have a continious text flow? Do I introduce every
...
\uncover<3->{\small{\textcolor{myred}{\XSolidBrush no uncertainties}}
  \qquad}
\uncover<4>{\small{\textcolor{myred}{\XSolidBrush {\it ``Theoretical''}?~Refs?}} }
\end{frame}
 ...
 \begin{frame}
   ...
   \item Never notate measured values \textbf{without} errors!
     \begin{align}
       m = (99.9 \pm 0.2) \text{g} \quad
       \text{\textbf{or}} \quad  m &= 99.9(2) \text{g}
     \end{align}
 ...
 %    e.g. $\Delta x = 0.783 \Rightarrow \Delta x \approx 0.8$
   ...
   \item Notate the mean value with the \textbf{same number of digits}
     ...
     \textcolor{mygreen}{$m = (99.9 \pm 0.2) \text{g}$\quad\quad\quad\Checkmark}
   \end{enumerate}
 \end{frame}
...
For a final value of
 ...
 \begin{frame}
   ...
   \begin{itemize}
   \item Do not forget to check the ``How to write a lab report''
...
\begin{frame}
  ...
  \item Submit the finished report to our \textbf{urkund emails}\\
    \pause
  \normalsize \item \textbf{Deadline for submitting the report}:\\
    ...
    \item in case you hand it in too late: Maximum grade can only be
      50 \% (pass)
    \end{itemize}\pause
  \item Corrections by the supervisor at most 15 working days. Reports
